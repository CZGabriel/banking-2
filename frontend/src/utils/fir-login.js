...
const firebaseConfig = {
  apiKey: "AIzaSyDQqSrzcVSelzdl5NlEJkmBOe667oUP7JM",
  authDomain: "hiphen-3de95.firebaseapp.com",
  projectId: "hiphen-3de95",
  storageBucket: "hiphen-3de95.appspot.com",
  messagingSenderId: "467059953705",
  appId: "1:467059953705:web:89a250a5bcb5b0fa9d8c38",
  measurementId: "G-31ZJCQSZXS"
};
...
const registerWithEmailAndPassword = async (name, email, password) => {
  ...
  .then(async () => {
    ...
    Swal.fire({
      ...
      text: 'Welcome to Carolinaz Bank',
      footer: ''
    })
  })
  .catch((error) => {
