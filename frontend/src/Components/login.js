        ...
        <Card 
            ...
            body={user ? (
                ...
                <ButtonGroup vertical>
                    <Link to="/reset" className="btn btn-primary">Forgot Password</Link>
                   <Link to="/createaccount"className="btn btn-primary" > Don't have an account? <br/>Register now</Link>
                </ButtonGroup>
                </>
                )
            }
